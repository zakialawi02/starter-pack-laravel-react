    ...
    return (
        <>
            ...
            <div className="relative min-h-screen bg-gray-100 bg-center sm:flex sm:justify-center sm:items-center bg-dots-darker dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                <div className="p-6 space-x-2 sm:fixed sm:top-0 sm:right-0 text-end">
                    {auth.user ? (
                        <>
                            <Link
                            ...
                            <Link
                                ...
                                method="post"
                                as="button"
                                className="font-semibold text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                            >
                                Log out
                            </Link>
                        </>
                ...
                <div className="p-6 mx-auto max-w-7xl lg:p-8">
                    ...
                    <div className="scale-100 my-3 mt-5 dark:text-white/70 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none  motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div className="mb-3">
                        ...
                        <div className="my-3 description">
                            <p>
                                This table provides a complete list of all
                                routes defined in the Laravel application. Each
                                route specifies the HTTP method, the URL path,
                                the controller/action handling the request,
                                middleware applied to the route, and the route
                                name if one is defined. Routes are grouped by
                                authentication roles (admin, writer, user,
                                guest) and specific functionalities such as user
                                management, authentication, profile editing, and
                                email verification. The Laravel framework uses
                                these routes to manage the application’s
                            ...
                            <table className="w-full text-left">
                                ...
                                <tbody className="border-b border-gray-500 divide-y divide-gray-400">
                                    ...
                                    <tr>
                                        ...
                                        <td className="description">
                                            Displays the user's profile edit
                                            form.
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            Inertia::render('Front/EmptyPage')
                                        </td>
                                        <td>
                                            auth, verified,
                                            role:admin,writer,user
                                        ...
                                        <td className="description">
                                            Displays an empty page, typically
                                    ...
                                    <tr>
                                        ...
                                        <td>auth, verified, role:admin</td>
                                        <td className="description">
                                            Displays the details of a specific
                                            user.
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>guest</td>
                                        <td className="description">
                                            Displays the registration form for
                                            new users.
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>guest</td>
                                        <td className="description">
                                            Processes registration of a new
                                            user.
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>guest</td>
                                        <td className="description">
                                            Authenticates users after they
                                    ...
                                    <tr>
                                        ...
                                        <td>guest</td>
                                        <td className="description">
                                            Displays the form to request a
                                            password reset link.
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>guest</td>
                                        <td className="description">
                                            Displays the form to reset the
                                            password using the token.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>POST</td>
                                        ...
                                        <td>guest</td>
                                        <td className="description">
                                            Processes the password reset with
                                            the new password.
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>auth</td>
                                        <td className="description">
                                            Displays the password confirmation
                                            form for the user.
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>auth</td>
                                        <td className="description">
                                            Confirms the user's password to
